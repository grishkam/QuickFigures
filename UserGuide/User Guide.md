...
2.	The **Figure** submenu appears in the popup menus for layouts and image panels if those objects are part of a figure.
    ...
    -	**All Channels**. A channels menu. The content of this submenu does not depend on which channels are present in the clicked panel. Otherwise it is similar to the other channels menu. [see the section on the channels menu for details](#Channels-Submenu) 
