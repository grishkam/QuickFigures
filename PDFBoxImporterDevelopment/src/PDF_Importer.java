...
public class PDF_Importer implements PlugIn {
	...
	private void onFirstRun() {
		...
		try {
			...
			ShowMessage.showOptionalMessage("You should be able to import PDF files into QuickFigures", true, "You can now import some objects from PDF files as vector graphics","Just drag and drop PDF files onto a QuickFigures worksheet", "The objects will be grouped together", "This is a work in progress","Move the layout to move the object");
