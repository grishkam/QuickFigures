...
/**An option to deselect currently selected items or */
public class SelectOrDeselectItem extends HideItem implements MultiSelectionOperator {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	boolean deselect=true;//does this deselect
	
	public SelectOrDeselectItem(boolean b) {
		deselect=b;
	}
	...
	public String getMenuCommand() {
		if (!deselect) 
			return "Items of Same Type (press a)";
