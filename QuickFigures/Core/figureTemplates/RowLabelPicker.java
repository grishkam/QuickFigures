...
public class RowLabelPicker extends GraphicalItemPicker<TextGraphic> implements MontageSpaces {
	...
	public boolean isDesirableItem(Object o) {
		...
		if (SnappingPosition. getGridchoices()[tg.getSnappingBehaviour().getGridLayoutSnapType()]!=getDesiredGridSnapType()) {
...
public void setToStandardFor(MultichannelDisplayLayer wrap) {
		...
		float h2=(float) (wrap.getWorkingStack().getHeight()*wrap.getPanelManager().getPanelLevelScale());
		float h=h2/5;
