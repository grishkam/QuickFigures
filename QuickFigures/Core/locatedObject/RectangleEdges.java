 ...
 * and for moving rectangles into those locations.
 * 
 * @see  RectangleEdgePositions for the location codes
 * @see AttachmentPosition for how this class is used
 * */
public class RectangleEdges implements  RectangleEdgePositions {
	...
	/**Turns a location code into a String
...
/**turns a list of positions into a set of Strings with the names of the locations*/
	...
	/**returns a list of attachment positions for text items*/
