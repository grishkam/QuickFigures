...
public ArrayList<Rectangle2D> getCompiledAboveAndLeftChains(Rectangle p) {
...
public void getLeftAndAboveSorted(Rectangle[] panels) {
...
public class leftNeighborCompartor implements Comparator<Rectangle>{
